...
$access = auth()->user()->akses();
          $acc = $access;
$cek = DB::table('acd_offered_course_exam as a')
->join('mstr_exam_type as b','a.Exam_Type_Id','=','b.Exam_Type_Id')
->where('a.Offered_Course_Exam_Id',$query->Offered_Course_Exam_Id)
->first();
?>
<section class="content">
    <div class="container-fluid-title">
        ...
        <div class="panel panel-default bootstrap-admin-no-table-panel">
          <div class="panel-heading-green">
            <div class="pull-right tombol-gandeng dua">
              ...
              @if(in_array('offered_course_exam-CanAddPeserta', $acc))
                @if($cek->Exam_Type_Id == 3)
                @else
      ...
      <div class="row">
        <div class="col-sm-6">
        <div >
            <label class="col-sm-5">Jenis UJIAN </label><label class="col-sm-1">:</label>
            <label  class="col-sm-5">{{ $cek->Exam_Type_Name }}</label>
        </div>
        <div >
        ...
        <table class="table table-striped table-font-sm" >
          <thead class="thead-default thead-green">
              <tr>
                  ...
                  @if($query->Exam_Type_Id == 3)
                  <th width="40%">Tagihan Remidi</th>
                  @endif
