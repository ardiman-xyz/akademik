  ...
  <div class="container">
    <div class="panel panel-default bootstrap-admin-no-table-panel">
      ...
      <div>
          ...
          <input type="text" hidden name="jml_peserta" value="{{ $count_mahasiswa->jml_peserta }}">
      </div>
      <hr>
      ...
      <div class="row  col-md-12 text-green">
        ...
        <div class="input-group date form-control form-control-sm col-md-3" id="datetimepicker1" data-target-input="nearest">
            <input type="text" name="Exam_Start_Date" class="form-control datetimepicker-input" placeholder="yyyy-mm-dd hh:ss" required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')" data-target="#datetimepicker1" />
