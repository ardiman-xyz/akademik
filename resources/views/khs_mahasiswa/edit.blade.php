    ...
    <div class="panel panel-default bootstrap-admin-no-table-panel">
      <div class="panel-heading-green">
        <div class="pull-right tombol-gandeng dua">
          <a href="{{ url('proses/khs_mahasiswa?nim='.$query->Nim.'&term_year='.$term_year) }}" class="btn btn-danger btn-sm">Kembali &nbsp;<i class="fa fa-reply"></i></a>
        </div>
      ...
      <div class="bootstrap-admin-panel-content bootstrap-admin-no-table-panel-content">
          ...
          @else
            ...
            @endif
          @endif
          {!! Form::open(['url' => route('khs_mahasiswa.update', $query->Krs) , 'method' => 'put', 'class' => 'form']) !!}

          @if($query->Khs_Id != "")
          <input type="hidden" name="Khs_Id" value="{{ $query->Khs_Id }}"  class="form-control">

          @endif

          @if($query->Transcript_Id != "")
          <input type="hidden" name="transcript_id" value="{{ $query->Transcript_Id }}"  class="form-control">

          @endif
          <input type="hidden" name="Student_Id" value="{{ $query->student }}"  class="form-control">

          <input type="hidden" name="Sks" value="{{ $query->Transcript_Sks }}"  class="form-control">
          <input type="hidden" name="Is_For_Transkrip" value="{{ $query->is_transcript }}"  class="form-control">

          <input type="hidden" name="Department_Id" value="{{ $department }}"  class="form-control">
          <input type="hidden" name="Term_Year_Id" value="{{ $term_year }}"  class="form-control">
