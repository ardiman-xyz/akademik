...
<section class="content">
          ...
          <table class="col-md-12" style="border:solid 1px;">
            ...
            <script>
                ...
                $.ajax({
                  ...
                  data: { prodi: prodi, format: format, no: no, default_term_year : term_year },
                  beforeSend: function () {
        ...
        <div style="padding:20px;">
          ...
          <table class="col-md-12" style="border:solid 1px;">
            ...
            <tr>
              ...
              @endphp
              <script>
                function delete_file_upload(format) {
                  ...
                  if (result) {
                    ...
                    // alert(params);
                    $.ajax({
                      url:"{!! url('/feeder/sync/delete/upload') !!}",
                      method:"GET",
                ...
                function delete_file_upload_update(format) {
                  var result = confirm("Want to delete?");
                  if (result) {
                    var prodi =  '<?php echo js_array($prodi) ?>';
                    event.preventDefault();
                    // alert(params);
                    $.ajax({
                      url:"{!! url('/feeder/sync/delete/upload_update') !!}",
                      method:"GET",
                      data: { prodi: prodi, format: format },
                      success:function(data)
                      {
              ...
              <td><?php if($dataDetailNew[0] != null){ ?><a href="{!! url('/storage/'.$dataDetailNew[0]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload('mahasiswa')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailUpdate[0] != null){ ?><a href="{!! url('/storage/'.$dataDetailUpdate[0]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload_update('mahasiswa')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailLog[0] != null){ ?><a href="{!! url('/storage/'.$dataDetailLog[0]->File_Name.'') !!}">Download</a><?php } ?></td>
              <td>
            ...
            <tr>
              ...
              <td><?php if($dataDetailNew[1] != null){ ?><a href="{!! url('/storage/'.$dataDetailNew[1]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload('mata_kuliah')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailUpdate[1] != null){ ?><a href="{!! url('/storage/'.$dataDetailUpdate[1]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload_update('mata_kuliah')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailLog[1] != null){ ?><a href="{!! url('/storage/'.$dataDetailLog[1]->File_Name.'') !!}">Download</a><?php } ?></td>
              <td>
                ...
                <form method="get" id="upload_updateMataKuliah" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <input name="prodi" type="text" value="<?php echo implode(',', $prodi); ?>" style="display:none;">
                  <input name="format" type="text" value="mata_kuliah" style="display:none;">
            ...
            <tr>
              ...
              <td><?php if($dataDetailNew[2] != null){ ?><a href="{!! url('/storage/'.$dataDetailNew[2]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload('kelas_kuliah')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailUpdate[2] != null){ ?><a href="{!! url('/storage/'.$dataDetailUpdate[2]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload_update('kelas_kuliah')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailLog[2] != null){ ?><a href="{!! url('/storage/'.$dataDetailLog[2]->File_Name.'') !!}">Download</a><?php } ?></td>
              <td>
                ...
                <form method="get" id="upload_updateKelasKuliah" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <input name="prodi" type="text" value="<?php echo implode(',', $prodi); ?>" style="display:none;">
                  <input name="format" type="text" value="kelas_kuliah" style="display:none;">
            ...
            <tr>
              ...
              <td><?php if($dataDetailNew[3] != null){ ?><a href="{!! url('/storage/'.$dataDetailNew[3]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload('ajar_dosen')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailUpdate[3] != null){ ?><a href="{!! url('/storage/'.$dataDetailUpdate[3]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload_update('ajar_dosen')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailLog[3] != null){ ?><a href="{!! url('/storage/'.$dataDetailLog[3]->File_Name.'') !!}">Download</a><?php } ?></td>
              <td>
            ...
            <tr>
              <td>5</td>
              <td>Bobot Nilai</td>
              <td><?php if($dataDetailNew[4] != null){ ?><a href="{!! url('/storage/'.$dataDetailNew[4]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload('bobot_nilai')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailUpdate[4] != null){ ?><a href="{!! url('/storage/'.$dataDetailUpdate[4]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload_update('bobot_nilai')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailLog[4] != null){ ?><a href="{!! url('/storage/'.$dataDetailLog[4]->File_Name.'') !!}">Download</a><?php } ?></td>
              <td>
            ...
            <tr>
              ...
              <td><?php if($dataDetailNew[5] != null){ ?><a href="{!! url('/storage/'.$dataDetailNew[5]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload('mahasiswa')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailUpdate[5] != null){ ?><a href="{!! url('/storage/'.$dataDetailUpdate[5]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload_update('niai')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailLog[5] != null){ ?><a href="{!! url('/storage/'.$dataDetailLog[5]->File_Name.'') !!}">Download</a><?php } ?></td>
              <td>
            ...
            <tr>
              ...
              <td><?php if($dataDetailNew[6] != null){ ?><a href="{!! url('/storage/'.$dataDetailNew[6]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload('kuliah_mahasiswa')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailUpdate[6] != null){ ?><a href="{!! url('/storage/'.$dataDetailUpdate[6]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload_update('kuliah_mahasiswa')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailLog[6] != null){ ?><a href="{!! url('/storage/'.$dataDetailLog[6]->File_Name.'') !!}">Download</a><?php } ?></td>
              <td>
            ...
            <tr>
              ...
              <td><?php if($dataDetailNew[7] != null){ ?><a href="{!! url('/storage/'.$dataDetailNew[7]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload('nilai_transfer')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailUpdate[7] != null){ ?><a href="{!! url('/storage/'.$dataDetailUpdate[7]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload_update('nilai_transfer')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailLog[7] != null){ ?><a href="{!! url('/storage/'.$dataDetailLog[7]->File_Name.'') !!}">Download</a><?php } ?></td>
              <td>
            ...
            <tr>
              ...
              <td><?php if($dataDetailNew[8] != null){ ?><a href="{!! url('/storage/'.$dataDetailNew[8]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload('mahasiswa_lulus_do')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailUpdate[8] != null){ ?><a href="{!! url('/storage/'.$dataDetailUpdate[8]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload_update('mahasiswa_lulus_do')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailLog[8] != null){ ?><a href="{!! url('/storage/'.$dataDetailLog[8]->File_Name.'') !!}">Download</a><?php } ?></td>
              <td>
            ...
            <tr>
              ...
              <td><?php if($dataDetailNew[9] != null){ ?><a href="{!! url('/storage/'.$dataDetailNew[9]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload('dosen_pembimbing')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailUpdate[9] != null){ ?><a href="{!! url('/storage/'.$dataDetailUpdate[9]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload_update('dosen_pembimbing')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailLog[9] != null){ ?><a href="{!! url('/storage/'.$dataDetailLog[9]->File_Name.'') !!}">Download</a><?php } ?></td>
              <td>
            ...
            <tr>
              ...
              <td><?php if($dataDetailNew[10] != null){ ?><a href="{!! url('/storage/'.$dataDetailNew[10]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload('bimbing_mahasiswa')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailUpdate[10] != null){ ?><a href="{!! url('/storage/'.$dataDetailUpdate[10]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload_update('bimbing_mahasiswa')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailLog[10] != null){ ?><a href="{!! url('/storage/'.$dataDetailLog[10]->File_Name.'') !!}">Download</a><?php } ?></td>
              <td>
            ...
            <tr>
              ...
              <td><?php if($dataDetailNew[11] != null){ ?><a href="{!! url('/storage/'.$dataDetailNew[11]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload('aktivitas_mahasiswa')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailUpdate[11] != null){ ?><a href="{!! url('/storage/'.$dataDetailUpdate[11]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload_update('aktivitas_mahasiswa')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailLog[11] != null){ ?><a href="{!! url('/storage/'.$dataDetailLog[11]->File_Name.'') !!}">Download</a><?php } ?></td>
              <td>
            ...
            <tr>
              ...
              <td><?php if($dataDetailNew[12] != null){ ?><a href="{!! url('/storage/'.$dataDetailNew[12]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload('anggota_aktivitas_mahasiswa')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailUpdate[12] != null){ ?><a href="{!! url('/storage/'.$dataDetailUpdate[12]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload_update('anggota_aktivitas_mahasiswa')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailLog[12] != null){ ?><a href="{!! url('/storage/'.$dataDetailLog[12]->File_Name.'') !!}">Download</a><?php } ?></td>
              <td>
            ...
            <tr>
              ...
              <td><?php if($dataDetailNew[13] != null){ ?><a href="{!! url('/storage/'.$dataDetailNew[13]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload('prestasi')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailUpdate[13] != null){ ?><a href="{!! url('/storage/'.$dataDetailUpdate[13]->File_Name.'') !!}">Download</a>&nbsp<a href="javascript:void(0)" onclick="delete_file_upload_update('prestasi')" style="color:red;">X</a> <?php } ?></td>
              <td><?php if($dataDetailLog[13] != null){ ?><a href="{!! url('/storage/'.$dataDetailLog[13]->File_Name.'') !!}">Download</a><?php } ?></td>
              <td>
  ...
  <script>
    ...
    function processBigArray(data, chunkSize) {
        ...
        if(d != null){
            ...
            var chunkArray = [];
            for (var i = 0; i < bigArray[0].length; i+=chunkSize) {
                chunkArray.push(Array.prototype.slice.call(bigArray[0], i, i+chunkSize));
            }
            ...
            return chunkArray.reduce(function(p, chunk) {
              ...
              // console.log(format);
                return p.then(function() {
                    return $.ajax({
                        type: 'POST',
                        url: "{!! url('/feeder/sync/insert_feeder/"+fmt+"') !!}",
                        headers: {
                            "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content")
                        },
                        data: {
              ...
              ress.push({'data':results,'format':fm});
              a++;
              processBigArray(data, chunkSize);
            });
            /////////////
        }else{
            // $('.buttonSyncronize').show();
    ...
    // usage
    processBigArray(someBigArrayq, 50).then(function(resultsq) {
