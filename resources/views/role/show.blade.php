          ...
          <div class="row">
            <div class="col-sm-6">
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" readonly name="nama" min="1" value="{{ $data_edit->name }}" required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')" class="form-control form-control-sm">
                </div>
              </div>
              <div class="form-group">
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <input type="text" readonly name="deskripsi" min="1" value="{{ $data_edit->description }}" required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')" class="form-control form-control-sm">
                  </div>
                </div>
              </div>
            </div>
                            ...
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1-1" data-id="custom-1-1" type="checkbox"> Organisasi</label>
                              <ul>
                                ...
                                <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Jabatan</label>
                                  <ul>
                                    <li><i></i> <label> <input name="access[]" type="checkbox" id="jabatan-CanView" value="{{ $accesses->where('name', 'jabatan-CanView')->first()->id }}"> {{ $accesses->where('name', 'jabatan-CanView')->first()->description }}</label></li>
                                    <li><i></i> <label> <input name="access[]" type="checkbox" id="jabatan-CanAdd" value="{{ $accesses->where('name', 'jabatan-CanAdd')->first()->id }}"> {{ $accesses->where('name', 'jabatan-CanAdd')->first()->description }}</label></li>
                                    <li><i></i> <label> <input name="access[]" type="checkbox" id="jabatan-CanEdit" value="{{ $accesses->where('name', 'jabatan-CanEdit')->first()->id }}"> {{ $accesses->where('name', 'jabatan-CanEdit')->first()->description }}</label></li>
                                    <li><i></i> <label> <input name="access[]" type="checkbox" id="jabatan-CanDelete" value="{{ $accesses->where('name', 'jabatan-CanDelete')->first()->id }}"> {{ $accesses->where('name', 'jabatan-CanDelete')->first()->description }}</label></li>
                                  </ul>
                                </li>
                          ...
                          <ul>
                            ...
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Pertemuan Kuliah</label>
                              <ul>
                                ...
                                <li><i></i> <label> <input name="accesses[]" type="checkbox" id="schedreal-CanAdd" value="{{ $accesses->where('name', 'schedreal-CanAdd')->first()->id }}"> {{ $accesses->where('name', 'schedreal-CanAdd')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="accesses[]" type="checkbox" id="schedreal-CanEdit" value="{{ $accesses->where('name', 'schedreal-CanEdit')->first()->id }}"> {{ $accesses->where('name', 'schedreal-CanEdit')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="accesses[]" type="checkbox" id="schedreal-CanDelete" value="{{ $accesses->where('name', 'schedreal-CanDelete')->first()->id }}"> {{ $accesses->where('name', 'schedreal-CanDelete')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="accesses[]" type="checkbox" id="schedreal-CanViewPeserta" value="{{ $accesses->where('name', 'schedreal-CanViewPeserta')->first()->id }}"> {{ $accesses->where('name', 'schedreal-CanViewPeserta')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="accesses[]" type="checkbox" id="schedreal-CanEditPeserta" value="{{ $accesses->where('name', 'schedreal-CanEditPeserta')->first()->id }}"> {{ $accesses->where('name', 'schedreal-CanEditPeserta')->first()->description }}</label></li>
                              </ul>
                            </li>
                          </ul>
                        </li>
                        <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Cetak</label>
                          <ul>
                            ...
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Kartu Ujian</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" id="kartuujian-CanView" value="{{ $accesses->where('name', 'kartuujian-CanView')->first()->id }}"> {{ $accesses->where('name', 'kartuujian-CanView')->first()->description }}</label></li>
                              </ul>
                            </li>
