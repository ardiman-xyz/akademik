                            ...
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1-1" data-id="custom-1-1" type="checkbox"> Akademik</label>
                              <ul>
                                ...
                                <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Status</label>
                                  <ul>
                                    <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'status-CanView')->first()->id }}"> {{ $access->where('name', 'status-CanView')->first()->description }}</label></li>
                                    <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'status-CanAdd')->first()->id }}"> {{ $access->where('name', 'status-CanAdd')->first()->description }}</label></li>
                                    <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'status-CanEdit')->first()->id }}"> {{ $access->where('name', 'status-CanEdit')->first()->description }}</label></li>
                                    <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'status-CanDelete')->first()->id }}"> {{ $access->where('name', 'status-CanDelete')->first()->description }}</label></li>
                                  </ul>
                                </li>
                              </ul>
                        ...
                        <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Parameter</label>
                          <ul>
                            ...
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Beban Mengajar</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'beban_mengajar-CanView')->first()->id }}"> {{ $access->where('name', 'beban_mengajar-CanView')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'beban_mengajar-CanAdd')->first()->id }}"> {{ $access->where('name', 'beban_mengajar-CanAdd')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'beban_mengajar-CanEdit')->first()->id }}"> {{ $access->where('name', 'beban_mengajar-CanEdit')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'beban_mengajar-CanDelete')->first()->id }}"> {{ $access->where('name', 'beban_mengajar-CanDelete')->first()->description }}</label></li>
                              </ul>
                            </li>
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Komponen Penilaian</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'komponen_penilaian-CanView')->first()->id }}"> {{ $access->where('name', 'komponen_penilaian-CanView')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'komponen_penilaian-CanAdd')->first()->id }}"> {{ $access->where('name', 'komponen_penilaian-CanAdd')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'komponen_penilaian-CanEdit')->first()->id }}"> {{ $access->where('name', 'komponen_penilaian-CanEdit')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'komponen_penilaian-CanDelete')->first()->id }}"> {{ $access->where('name', 'komponen_penilaian-CanDelete')->first()->description }}</label></li>
                              </ul>
                            </li>
                          </ul>
                        </li>
                        <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Setting</label>
                          <ul>
                            ...
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Data RFID Mahasiswa</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'rfid-CanView')->first()->id }}"> {{ $access->where('name', 'rfid-CanView')->first()->description }}</label></li>
                              </ul>
                            </li>
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Mahasiswa Aktif / Keluar</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'studentmundurkeluardo-CanView')->first()->id }}"> {{ $access->where('name', 'studentmundurkeluardo-CanView')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'studentmundurkeluardo-CanAdd')->first()->id }}"> {{ $access->where('name', 'studentmundurkeluardo-CanAdd')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'studentmundurkeluardo-CanEdit')->first()->id }}"> {{ $access->where('name', 'studentmundurkeluardo-CanEdit')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'studentmundurkeluardo-CanDelete')->first()->id }}"> {{ $access->where('name', 'studentmundurkeluardo-CanDelete')->first()->description }}</label></li>
                              </ul>
                            </li>
                            ...
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Option Semester Pendek</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'short_term-CanView')->first()->id }}"> {{ $access->where('name', 'short_term-CanView')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'short_term-CanEdit')->first()->id }}"> {{ $access->where('name', 'short_term-CanEdit')->first()->description }}</label></li>
                              </ul>
                            </li>
                          ...
                          <ul>
                            ...
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">KRS Per Mahasiswa</label>
                              <ul>
                                ...
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'krs_mahasiswa-CanExport')->first()->id }}"> {{ $access->where('name', 'krs_mahasiswa-CanExport')->first()->description }}</label></li>
                              </ul>
                            </li>
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">KRS Per Paket</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'krs_paket-CanView')->first()->id }}"> {{ $access->where('name', 'krs_paket-CanView')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'krs_paket-CanAdd')->first()->id }}"> {{ $access->where('name', 'krs_paket-CanAdd')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'krs_paket-CanEdit')->first()->id }}"> {{ $access->where('name', 'krs_paket-CanEdit')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'krs_paket-CanDelete')->first()->id }}"> {{ $access->where('name', 'krs_paket-CanDelete')->first()->description }}</label></li>
                              </ul>
                            </li>
                            ...
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Mahasiswa Kuesioner</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'krslist-CanView')->first()->id }}"> {{ $access->where('name', 'krslist-CanView')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'krslist-CanAdd')->first()->id }}"> {{ $access->where('name', 'krslist-CanAdd')->first()->description }}</label></li>
                              </ul>
                            </li>
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Berkas Yudisium</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'berkascuti-CanView')->first()->id }}"> {{ $access->where('name', 'berkascuti-CanView')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'berkascuti-CanEdit')->first()->id }}"> {{ $access->where('name', 'berkascuti-CanEdit')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'masterberkascuti-CanEdit')->first()->id }}"> {{ $access->where('name', 'masterberkascuti-CanEdit')->first()->description }}</label></li>
                              </ul>
                            </li>
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Cuti</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'cuti-CanView')->first()->id }}"> {{ $access->where('name', 'cuti-CanView')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'cuti-CanAdd')->first()->id }}"> {{ $access->where('name', 'cuti-CanAdd')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'cuti-CanDelete')->first()->id }}"> {{ $access->where('name', 'cuti-CanDelete')->first()->description }}</label></li>
                              </ul>
                            </li>
                            ...
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Pertemuan Kuliah</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'schedreal-CanView')->first()->id }}"> {{ $access->where('name', 'schedreal-CanView')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'schedreal-CanAdd')->first()->id }}"> {{ $access->where('name', 'schedreal-CanAdd')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'schedreal-CanEdit')->first()->id }}"> {{ $access->where('name', 'schedreal-CanEdit')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'schedreal-CanDelete')->first()->id }}"> {{ $access->where('name', 'schedreal-CanDelete')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'schedreal-CanViewPeserta')->first()->id }}"> {{ $access->where('name', 'schedreal-CanViewPeserta')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'schedreal-CanEditPeserta')->first()->id }}"> {{ $access->where('name', 'schedreal-CanEditPeserta')->first()->description }}</label></li>
                              </ul>
                            </li>
                          </ul>
                        </li>
                        <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Cetak</label>
                          <ul>
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Peserta Matakuliah</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'peserta_matakuliah-CanView')->first()->id }}"> {{ $access->where('name', 'peserta_matakuliah-CanView')->first()->description }}</label></li>
                              </ul>
                            </li>
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Cetak KTM</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'ktm-CanView')->first()->id }}"> {{ $access->where('name', 'ktm-CanView')->first()->description }}</label></li>
                                {{-- <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'ktm-CanExport')->first()->id }}"> {{ $access->where('name', 'ktm-CanExport')->first()->description }}</label></li> --}}
                              </ul>
                            </li>
                            ...
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Cetak Ijazah</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'ijazah-CanView')->first()->id }}"> {{ $access->where('name', 'ijazah-CanView')->first()->description }}</label></li>
                                {{-- <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'ijazah-CanExport')->first()->id }}"> {{ $access->where('name', 'ijazah-CanExport')->first()->description }}</label></li> --}}
                              </ul>
                            </li>
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Kartu Ujian</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'kartuujian-CanView')->first()->id }}"> {{ $access->where('name', 'kartuujian-CanView')->first()->description }}</label></li>
                              </ul>
                            </li>
                            ...
                            <!-- <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Download panduan Simak</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'panduan-CanView')->first()->id }}"> {{ $access->where('name', 'panduan-CanView')->first()->description }}</label></li>
                              </ul>
                            </li> -->
                            <!-- <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Download Diagram Persemester</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'diagram-CanView')->first()->id }}"> {{ $access->where('name', 'diagram-CanView')->first()->description }}</label></li>
                              </ul>
                            </li> -->
                          </ul>
                        </li>
                        <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Laporan</label>
                          <ul>
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Pengisian Nilai Oleh Dosen</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'detail_pengisian_nilai-CanView')->first()->id }}"> {{ $access->where('name', 'detail_pengisian_nilai-CanView')->first()->description }}</label></li>
                              </ul>
                            </li>
                            ...
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Pembayaran Mahasiswa</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'laporan_pembayaran_mahasiswa-CanView')->first()->id }}"> {{ $access->where('name', 'laporan_pembayaran_mahasiswa-CanView')->first()->description }}</label></li>
                              </ul>
                            </li>
                            ...
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Laporan Data Mahasiswa</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'laporandatamahasiswa-CanView')->first()->id }}"> {{ $access->where('name', 'laporandatamahasiswa-CanView')->first()->description }}</label></li>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'laporandatamahasiswa-CanExport')->first()->id }}"> {{ $access->where('name', 'laporandatamahasiswa-CanExport')->first()->description }}</label></li>
                              </ul>
                            </li>
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Export Feeder</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'exportfeeder-CanView')->first()->id }}"> {{ $access->where('name', 'exportfeeder-CanView')->first()->description }}</label></li>
                              </ul>
                            </li>
                            <li><i class="fa fa-plus"></i> <label> <input id="node-0-1" data-id="custom-1" type="checkbox">Pencapaian Mahasiswa</label>
                              <ul>
                                <li><i></i> <label> <input name="access[]" type="checkbox" value="{{ $access->where('name', 'sertifikat-CanView')->first()->id }}"> {{ $access->where('name', 'sertifikat-CanView')->first()->description }}</label></li>
                              </ul>
                            </li>
                          </ul>
                        </li>
