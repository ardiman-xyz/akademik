...
<section class="content">
  <div class="container-fluid-title">
    <div class="title-laporan">
      <h3 class="text-white">Berita Acara Yudisium</h3>
    </div>
  </div>
  <div class="container">
    <div class="panel panel-default bootstrap-admin-no-table-panel">
      ...
      <div class="bootstrap-admin-panel-content bootstrap-admin-no-table-panel-content">
          ...
          {!! Form::open(['url' => route('beritaacara_yudisium.storeberitaacara_yudisium') , 'method' => 'POST', 'class' => 'form-horizontal', 'role' => 'form' , 'enctype' => 'multipart/form-data' ]) !!}
          {{ csrf_field() }}
          {{ method_field('post') }}
          ...
          <div class="col-sm-6">
              ...
              <div>
                ...
                <label for="" class="col-sm-5"><input type="text" name="nomor" value="{{ $data->Sk_Num }}"  class="form-control form-control-sm"></label>
              </div>
              ...
              <div>
                ...
                <select class="form-control-sm col-sm-5" name="jabatan2">
              ...
              <div>
                ...
                <select id="select" class="form-control-sm col-sm-5 pejabat" name="pejabat">
                  <option value="0">Pilih...</option>
          ...
          {!! Form::close() !!}
          <label class="col-sm-5"><a href="{{ url('proses/yudisium/'.$mhs->Student_Id.'/export?proses=2') }}" class="btn btn-info btn-sm" style="margin:5px;" target="_blank">Proses/Cetak <i class="fa fa-print"></i> </a></label>
