...
<section class="content">
  ...
  <div class="container">
    <div class="panel panel-default bootstrap-admin-no-table-panel">
      ...
      <br>
          <!-- <b>Daftar Fakultas</b> -->
          {!! Form::open(['url' => route('offered_course_sched.index') , 'method' => 'GET', 'name' => 'form', 'role' => 'form', 'style' => 'padding-top:5px;padding-left:15px;padding-right:15px;']) !!}
          	...
          	<div class="row text-green" style="padding-top:5px;padding-left:15px;padding-right:15px;">
            	...
            	<div  class="row col-md-5">
		            ...
		            <select class="form-control form-control-sm col-md-7" name="rowpage" onchange="document.form.submit()">
...
<script>
    $("#export").click(function(e) {
      ...
      var class_program = $('#kpg').val();
        window.open("{{ url('') }}/setting/offered_course_sched/exportdata/exportdata/" + department + "/" + term_year+ "/" + class_program); 
    });
