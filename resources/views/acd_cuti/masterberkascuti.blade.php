...
<section class="content">
  ...
  <div class="container-fluid-title">
    <div class="title-laporan">
      <h3 class="text-white">Master Berkas Cuti</h3>
    </div>
  </div>
  <br>
  <div class="container">
    <div class="panel panel-default bootstrap-admin-no-table-panel">
      <div class="panel-heading-green">
        <div class="pull-right tombol-gandeng dua">
          <a href="{{ url('proses/cuti/berkascuti/data') }}" class="btn btn-danger btn-sm" class="btn btn-danger btn-sm">Kembali &nbsp;<i class="fa fa-reply"></i></a>
        </div>
    ...
    dataSource: {
        transport: {
            read: function(options) {
                $.ajax({
                    dataType: 'json',
                    url: "{{ route('api.get.master_berkas_cuti') }}",
                    type: 'GET',
                    data: options.data,
          ...
          create: function(options) {
                $.ajax({
                    dataType: 'json',
                    url: "{{ route('api.post.master_berkas_cuti') }}",
                    type: 'post',
                    data: {
        ...
        actions: [
            {
                ...
                action: function (e) {
                    $.ajax({
                        ...
                        url: "{{ route('api.delete.master_berkas_cuti') }}",
                        type: "delete",
                        data: {
                          data:data.Vacation_Document_Id,
                        },
                        dataType: "json",
                        success: function (res) {
                            if(res.success == true){
...
//detail init
  function detailInit(e) {
    ...
    editable: "inline",
    edit: function (d) {
      if(d.model.Vacation_Document_Id == '' || d.model.Vacation_Document_Id == null){
        d.container.find("input[name=Vacation_Document_Id]").kendoMultiSelect({
