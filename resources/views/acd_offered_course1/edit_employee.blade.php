  ...
  <div class="container">
    <div class="panel panel-default bootstrap-admin-no-table-panel">
      ...
      <div class="bootstrap-admin-panel-content bootstrap-admin-no-table-panel-content">
          ...
          <div class="form-group">
            {!! Form::label('', 'elas yang ditawarkan', ['class' => 'col-md-4 form-label']) !!}
            <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <div class="col-md-12">
              <select id="select"  class="form-control form-control-sm" name="Employee_Id[]" multiple>
                  ...
                  <option  value="{{ $employee->Employee_Id }}">{{ $employee->First_Title }} {{ $employee->Name }} {{ $employee->Last_Title }}</option>
                  @endforeach
              </select>
            </div>
          </div>
          ...
          <div class="form-group" id="dosen_luar">
            ...
            <div class="col-md-12">
              <select id="select2"  class="form-control form-control-sm" name="Employee_Id[]" multiple>
                  @foreach($select_employee2 as $employee)
                  <option  value="{{ $employee->Employee_Id }}">{{ $employee->First_Title }} {{ $employee->Name }} {{ $employee->Last_Title }}</option>
                  @endforeach
              </select>
            </div>
