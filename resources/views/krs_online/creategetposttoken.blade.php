    ...
    <script>
        $(function () {
          ...
          $("#beasiswaa").hide();
            ...
            $.ajax({
                url: "http://localhost:80/krsonline_stttnas/public/api/krs_online/course_list/create",
                type: "GET",
                        ...
                        $('#mata_kuliah').change(function () {
                            ...
                            if (courseid !== undefined) {
                              ...
                              $.ajax({
                                  ...
                                  url: "http://localhost:80/krsonline_stttnas/public/api/krs_online/coursecost/" +  courseid,
                                  type: "GET",
                                  data: {'nim':'{{ $_GET['nim'] }}','term_year':'{{ $_GET['term_year'] }}'},
                                  dataType: "JSON",
                                  success: function (result) {
                                ...
                                $.ajax({
                                    ...
                                    url: "http://localhost:80/krsonline_stttnas/public/api/krs_online/class/" +  courseid,
                                    type: "GET",
                                    data: {'nim':'{{ $_GET['nim'] }}','term_year':'{{ $_GET['term_year'] }}'},
                                    dataType: "JSON",
                                    success: function (result) {
                                        ...
                                        $('#daftar_kelas').change(function () {
                                            ...
                                            $.ajax({
                                                ...
                                                url: "http://localhost:80/krsonline_stttnas/public/api/krs_online/classinfo/" + courseid + "/" + classid,
                                                type: "GET",
                                                data: {'nim':'{{ $_GET['nim'] }}','term_year':'{{ $_GET['term_year'] }}'},
                                                dataType: "JSON",
                                                success: function (result) {
                            ...
                            if (courseid.length <= 0) {
                                ...
                                if (classid.length <= 0) {
                                  ...
                                  $.ajax({
                                    ...
                                    url: "http://localhost:80/krsonline_stttnas/public/api/krs_online/posttoken/",
                                    type: "get",
                                    data: {'xxx':nim,'nim':{{ $_GET['nim'] }}},
                                    dataType: "JSON",
                                    success: function (result) {
                                      if (result.success == 'success') {
                                        $.ajax({
                                          ...
                                          url: "http://localhost:80/krsonline_stttnas/public/api/krs_online/prerequisitecourse/" + courseid + "/" + classid,
                                          type: "GET",
                                          data: {'nim':'{{ $_GET['nim'] }}','term_year':'{{ $_GET['term_year'] }}'},
                                          dataType: "JSON",
                                          success: function (result) {
                                            ...
                                            if (result.success == 'false') {
                                              ...
                                              $.ajax({
                                                ...
                                                url: "http://localhost:80/krsonline_stttnas/public/api/krs_online/prerequisiteclass/" + courseid + "/" + classid,
                                                type: "GET",
                                                data: {'nim':'{{ $_GET['nim'] }}','term_year':'{{ $_GET['term_year'] }}'},
                                                dataType: "JSON",
                                                success: function (result) {
                                                  ...
                                                  if (result.success == 'false') {
                                                    ...
                                                    $.ajax({
                                                      ...
                                                      url: "http://localhost:80/krsonline_stttnas/public/api/krs_online/gettoken/",
                                                      type: "get",
                                                      data: {'nim':{{ $_GET['nim'] }}},
                                                      dataType: "JSON",
                                                      success: function (result) {
                                                        if (result.success == 'false') {
                                                          ...
                                                          $.ajax({
                                                            ...
                                                            url: "http://localhost:80/krsonline_stttnas/public/api/krs_online/store/",
                                                            type: "GET",
                                                            data: data,
                                                            dataType: "JSON",
                                                            success: function (result) {
