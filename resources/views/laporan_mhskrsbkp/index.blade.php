                ...
                <tr>
                    ...
                    if ($data->JumlahMhsAktif != 0) {
                      ...
                      <td><center>
                        ...
                        <a  style="text-decoration:none;" href="{{ url('laporan/laporan_mhskrs/'.$data->dep_Id.'?term_year='.$term_year.'&prog_kelas='.$prog_kelas.'&angkatan='.$entry_year) }}">{{ $data->JumlahMhsAktif }} &nbsp <span class="glyphicon glyphicon-zoom-in"></span></a>
                        @else
                        {{ $data->JumlahMhsAktif }}
                        @endif
                      </center></td>
                    ...
                    if ($data->MhsCuti != 0) {
                      ?>
                      <td><center>
                      <a  style="text-decoration:none;" href="{{ url('laporan/laporan_mhskrs/showmhscuti/'.$data->dep_Id.'?term_year='.$term_year.'&prog_kelas='.$prog_kelas.'&angkatan='.$entry_year) }}">{{ $data->MhsCuti }} &nbsp <span class="glyphicon glyphicon-zoom-in"></span></a>
                      </center></td>
                      <?php
                    }else {
                      ?>
                    ...
                    if ($data->JumlahMhsNonAktif != 0) {
                      ...
                      <td><center>
                        ...
                        <a  style="text-decoration:none;" href="{{ url('laporan/laporan_mhskrs/showmhsnonaktif/'.$data->dep_Id.'?term_year='.$term_year.'&prog_kelas='.$prog_kelas.'&angkatan='.$entry_year) }}">{{ $data->JumlahMhsNonAktif }} &nbsp <span class="glyphicon glyphicon-zoom-in"></span></a>
                        @endif
                      </center></td>
                      <?php
                    }else {
