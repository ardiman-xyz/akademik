        ...
        <div class="row" style="padding-top:5px;padding-left:15px;padding-right:15px;">
          <div class="col-sm-6">
            ...
            <div>
              ...
              <input type="text" value="{{$da1uas}}" id="startuas" hidden>
...
function fnExcelReport() {
        ...
        var grid = $('#grid').kendoGrid({ 
            ...
            edit: function (e) {
                if (!e.model.isNew()) {
                  ...
                  console.log(e.model);
                  // var same = $("#startuas").val() === $("#enduas").val();
                  ...
                  // console.log(e.container.find("[name]").first().attr("name"));
                  if(e.container.find("[name]").first().attr("name") == "Uts"){
                    if (e.model.Ujian_uts == 0) {
                      e.sender.closeCell();
                    }else{
                      if(presence == 0){
                        e.sender.closeCell();
                  ...
                  if(e.container.find("[name]").first().attr("name") == "Uas"){
                    if (e.model.ujian_uas == 0) {
                      e.sender.closeCell();
                    }else{
                      if(presence_uas == 0){
                        e.sender.closeCell();
    ...
    $(document).on('click', '.defaultnilaiuas', function (e) {
      var countuas = <?php echo $countuas ?>;
      if(countuas > 0){
        swal({
            title: "Maaf",
            text: 'Nilai UAS ada yang sudah terisi',
            type: "warning",
            confirmButtonColor: "#02991a",
        ...
        if(bisa == 1){
          ...
          swal({
            title: "Maaf",
            text: 'Pengisinan Nilai Dosen Belum berkahir',
            type: "warning",
            confirmButtonColor: "#02991a",
            confirmButtonText: "Ok.",
            cancelButtonText: "Tidak, Batalkan!",
