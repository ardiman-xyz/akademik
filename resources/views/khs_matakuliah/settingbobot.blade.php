                        ...
                        <span class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                  ...
                                  <input type="text" id="col_8" name="UAS"class="k-textbox form-control-sm" value="40" style="margin-bottom:2px;height:30px"onchange="colTot(8)"></br >
                                  <input type="text" id="col_1" hidden name="Presensi"class="k-textbox form-control-sm" value="{{$data['Presensi']}}" style="margin-bottom:2px;height:30px" onchange="colTot(1)"></br >
                                  ...
                                  <input type="text" id="col_3" hidden name="Tugas_2"class="k-textbox form-control-sm" value="{{$data['Tugas_2']}}"style="margin-bottom:2px;height:30px"onchange="colTot(3)"></br>
                                  <input type="text" id="col_4" hidden name="Tugas_3"class="k-textbox form-control-sm" value="{{$data['Tugas_3']}}"style="margin-bottom:2px;height:30px"onchange="colTot(4)"></br >
                                  <input type="text" id="col_5" hidden name="Tugas_4"class="k-textbox form-control-sm" value="{{$data['Tugas_4']}}"style="margin-bottom:2px;height:30px"onchange="colTot(5)"></br >
                                  <input type="text" id="col_6" hidden name="Tugas_5"class="k-textbox form-control-sm" value="{{$data['Tugas_5']}}"style="margin-bottom:2px;height:30px"onchange="colTot(6)"></br >
                                  <hr>
