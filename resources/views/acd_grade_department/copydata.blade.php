...
<section class="content">
  <div class="container-fluid-title">
    <div class="title-laporan">
      <h3 class="text-white">Kopi Grade Nilai</h3>
    </div>
  </div>
  <div class="container">
    <div class="panel panel-default bootstrap-admin-no-table-panel">
      <div class="panel-heading-green">
        ...
        <div class="pull-right tombol-gandeng dua">
            <a  href="{{ url('parameter/grade_department?department='.$department.'&term_year='.$term_year) }}" class="btn btn-danger btn-sm">Kembali &nbsp;<i class="fa fa-reply"></i></a>
          </div>
          <b>Kopi Grade Nilai</b>
        </div>
      </div>
      <br>
      ...
      @if (count($errors) > 0)
          ...
          {!! Form::open(['url' => route('grade_department.storecopydata') , 'method' => 'POST', 'class' => 'form-horizontal', 'role' => 'form']) !!}
