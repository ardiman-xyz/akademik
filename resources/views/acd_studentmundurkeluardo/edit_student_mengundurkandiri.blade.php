  ...
  <div class="container">
    <div class="panel panel-default bootstrap-admin-no-table-panel">
      ...
      <div class="bootstrap-admin-panel-content bootstrap-admin-no-table-panel-content">
        ...
        @endif
        <br>
        {!! Form::open(['url' => route('studentmundurkeluardo.update_student_mengundurkandiri',$db_out->Student_Id) , 'method' => 'PUT', 'class' => 'form-horizontal', 'role' => 'form']) !!}
