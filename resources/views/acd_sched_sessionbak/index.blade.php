      ...
      <div class="panel-heading-green">
        <div class="bootstrap-admin-box-title right text-white">
          ...
          <div class="pull-right tombol-gandeng dua">
            ...
            @if(in_array('sched_session-CanAdd', $acc)) <a href="{{ url('setting/sched_session/create?sched_session_group_id='.$Sched_Session_Group_Id.'&sched_type_id='.$Sched_Type_Id ) }}" class="btn btn-success btn-sm">Tambah data &nbsp;<i class="fa fa-plus"></i></a>@endif
          </div>
          @endif
          <!-- <b>Daftar Fakultas</b> -->
