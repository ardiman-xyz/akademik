    ...
    <table style="width:100%; text-align:left" style="font-size:13px;">
      <tr>
        ...
        <td style="width:30%;">
          ...
          ?>
          <label for="" style="font-size:13px;">Yogyakarta, <?php echo tanggal_indo($tgl_terbit,false) ?></label><br>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td style="font-size:13px;"><?php echo $student_data->Department_Name; ?>, </td>
        <td style="font-size:13px;">Pembimbing Akademik,</td>
      ...
      <tr>
        <td style="font-size:13px;"><?php echo $functional_name; ?></td>
        ...
        <td style="font-size:13px;"><?php echo $student_data->Full_Name ?></td>
      </tr>
    </table>
    <br>
