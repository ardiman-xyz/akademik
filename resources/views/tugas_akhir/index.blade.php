      ...
      <div class="panel-heading-green">
        <div class="bootstrap-admin-box-title right text-white">
          <div class="pull-right tombol-gandeng dua">
            ...
            if ($department > 0 && $term_year > 0 && $entry_year > 0) {
              ...
              foreach ($query as $data) {
                ...
                <tr>
                    ...
                    <td align="center">
                      ...
                      <a href="{{ url('proses/tugas_akhir/'.$data->Thesis_Id.'?department='.$department.'&page='.$page.'&rowpage='.$rowpage.'&search='.$search.'&term_year='.$term_year) }}" class="btn btn-success btn-sm">Detail</a>
                      @if(in_array('tugas_akhir-CanEdit', $acc))<a href="{{ url('proses/tugas_akhir/'.$data->Thesis_Id.'/edit?department='.$department.'&page='.$page.'&rowpage='.$rowpage.'&search='.$search.'&term_year='.$term_year) }}" class="btn btn-info btn-sm">Edit</a>@endif 
