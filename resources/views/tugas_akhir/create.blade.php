    ...
    <div class="panel panel-default bootstrap-admin-no-table-panel">
      ...
      <div class="bootstrap-admin-panel-content bootstrap-admin-no-table-panel-content">
        ...
        @endif
          ...
          {{ csrf_field() }}
          {{ method_field('post') }}
          <input type="hidden" name="term_year"  value="{{$request->term_year}}"  class="form-control">
          <input type="hidden" name="angkatan"  value="{{$request->angkatan}}"  class="form-control">
          ...
          <!-- <div class="form-group">
            ...
            <div class="col-md-12">
              <select id="exam3" class="form-control form-control-sm col-md-12" name="penguji3">
