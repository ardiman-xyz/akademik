...
<section class="content">
  <div class="container-fluid-title">
    <div class="title-laporan">
      <h3 class="text-white">DETAIL MAHASISWA LULUS</h3>
    </div>
  </div>
  <div class="container">
    <div class="panel panel-default bootstrap-admin-no-table-panel">
      <div class="panel-heading-green">
        ...
        <div class="bootstrap-admin-box-title right text-white">
          <b>Detail Mahasiswa Lulus Prodi {{$department->Department_Name}} th/smt {{ $thsmt->Term_Year_Name }}</b>
        </div>
      </div>
        </div>
...
<input type="text" name="id_prod" hidden value="{{ $id }}">
          ...
          <a href="{{ url('laporan/laporan_mhskrs/exportexcelcuti/exportexcelcuti?term_year='.$term_year.'&prog_kelas='.$prog_kelas.'&angkatan='.$entry_year.'&department='.$id) }}" target="_blank" class="btn btn-primary btn-sm" style="float:left; font-size:medium;margin-right:5px;">Export Excel &nbsp;<i class="fa fa-print"></i></a>
