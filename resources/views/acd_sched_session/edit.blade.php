    ...
    <div class="panel panel-default bootstrap-admin-no-table-panel">
      <div class="panel-heading-green">
        <div class="pull-right tombol-gandeng dua">
          <a href="{{ url('setting/sched_session?sched_session_group_id='.$data->Sched_Session_Group_Id.'&sched_type_id='.$data->Sched_Type_Id.'&term_year='.$data->Term_Year_Id) }}" class="btn btn-danger btn-sm">Batal &nbsp;<i class="fa fa-close"></i></a>
        </div>
