        ...
        @endif
          ...
          <input type="hidden" hidden name="krs_id"  value=""  class="form-control krs_id">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                  <input type="text" readonly name="nm_matakuliah" value="{{$matakuliah->Course_Name}}"  class="form-control form-control-sm">
                </div>
              </div>
              <input type="text"  hidden name="matakuliah" value="{{$matakuliah->Course_Id}}"  class="form-control form-control-sm">
          ...
          <div class="form-group">
            {!! Form::label('', 'sks_krs', ['class' => 'col-md-4 form-label']) !!}
            <div class="col-md-12">
              <input type="text" name="sks_krs" value=""  class="form-control form-control-sm sks_krs">
            </div>
          </div>
...
<script type="text/javascript">
	$(document).ready(function(){
      ...
      var matakuliah = <?php echo $matakuliah->Course_Id; ?>;
			var a=$(this).parent();
			var op="";
      var url = {!! json_encode(url('/')) !!};
			$.ajax({
				...
				data:{'Student_Id':student_id,'Course_Id':matakuliah},
				dataType:'json',//return data will be json
				success:function(data){
            console.log(data);
           $(".krs_id").val(data.Krs_Id);
           $(".sks_krs").val(data.Sks);
