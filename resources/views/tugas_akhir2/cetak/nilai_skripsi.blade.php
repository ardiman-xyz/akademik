...
<body>
  ...
  <table style="width:100%; font-size:15px;">
      ...
      <tr>
        <td width=" 15%"></td>
        <td width=" 70%"><center><b>NILAI SKRIPSI</b></td>
        <td width=" 15%"></td>
      </tr>
    </table>
    ...
    <table style="width:100%; font-size:10pt;">
        ...
        <tr>
          ...
          <p>Skripsi tersebut telah dipresentasikan dalam Ujian Pendadaran pada tanggal, <br>
            selanjutnya dinyakatak MEMENUHI syarat dan mendapatkan Nilai &nbsp;&nbsp;&nbsp; ____________</p>
          </td>
        </tr>
    </table>
    <br>
      ...
      <table id="table2" style="width:100%; font-size:9pt;">
        <thead>
          <tr>
            <td width="30%"></td>
            <td width="40%"></td>
            <td width="30%">Yogyakarta, _____________________</td>
          </tr>
          <tr >
