...
<br>
  <table style="width:100%; font-size:15px;">
      <tr>
        <td>Hal</td>
        <td>:</td>
        <td>Undangan Pendadaran Tugas Akhir</td>
      </tr>
      <tr>
        <td></td>
        <td></td>
  ...
  <p>Bersama ini diharapkan kehadiran Bapak/Ibu pada Seminar Tugas Akhir mahasiswa :
    ...
    <p>Insya Allah akan diselenggarakan pada :
      ...
      <table style="width:100%; font-size:10pt;">
          ...
          <?php
          $semdate = strtotime($data->Thesis_Exam_Date);
...
<table style="width:100%; font-size:10pt;">
    <tr>
      <td width=" 60%"></td>
      <td width=" 40%"><center>{{env('NAME_City')}}, _______________ <br> Ketua / Sekretaris Jurusan</td>
    </tr>
    <tr>
      <td height="60px"></td>
      <td><center> </td>
  ...
  <p style="font-size:8pt;">
    <i>Tembusan :
      <br>1. TU Fakultas <br>2. Referensi Fakultas <br>3. Mahasiswa ybs
  </p>
<p style="font-size:8pt;">
  <i>Catatan :
