...
class Transcript_akhirController extends Controller
{
  /**
  ...
  {
    $nim_ = Input::get('nim');
    $student=DB::table('acd_student')->where('Nim',$nim_)->select('acd_student.*')->first();
    ...
    return view('cetak/index_transcriptakhir')->with('student',$student)->with('query_', $query)->with('query',$data)->with('nim',$nim_);
  }
   ...
   */
   ...
   public function export($id)
   {
     ...
     $nim = Input::get('nim');
     $student=DB::table('acd_student')->where('Nim',$id)->join('mstr_department','mstr_department.Department_Id','=','acd_student.Department_Id')
    ...
    ->first();
     ...
     $thesis_title=DB::table('acd_thesis')->join('acd_student','acd_student.Student_Id','=','acd_thesis.Student_Id')->where('acd_student.Nim',$id)->select('acd_thesis.Thesis_Title')->first();

     View()->share(['thesis_title'=>$thesis_title,'enddate_thesis'=>$enddate_thesis,'predikat'=>$predikat,'program_type'=>$program_type,'faculty'=>$faculty,'ttd'=>$ttd,'dekan'=>$namadekan,'dosen'=>$dosen,'query_'=>$query,'data'=> $data,'nim'=>$nim,'student'=>$student]);
